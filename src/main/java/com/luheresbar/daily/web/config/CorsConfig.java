...
public class CorsConfig {
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        corsConfiguration.setAllowedOrigins(Arrays.asList("URL: https://dailyexpenses-dev.web.app")); // En este momento estamos permitiendo todas las peticiones que lleguen desde este origen.
