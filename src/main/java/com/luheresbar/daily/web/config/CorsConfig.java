...
public class CorsConfig {
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        // corsConfiguration.setAllowedOrigins(Arrays.asList("http://localhost:4200")); // En este momento estamos permitiendo todas las peticiones que lleguen desde este origen.
